...
if($_GET['filter'] == ""){
$sql_get_data = "select * from tb_profile_ufe limit 1";
...
"idUser":"<?php echo $hg2['id_profile']; ?>",
  "username":"<?php echo $hg2['nama_ufe']; ?>",
  "first_name":"<?php echo $hg2['nama_ufe']; ?>",
  "second_name":"<?php echo $hg2['nama_ufe']; ?>",
  "deskripsi":"<?php echo $desk7; ?>",
  "phone":"<?php echo $hg2['telepon']; ?>",
  "mobile":"<?php echo $hg2['mobile']; ?>",
  "propic":"<?php echo $hg2['logo_ufe']; ?>",
  ...
  "cover":"<?php echo $hg2['foto_cover']; ?>",
  "logo":"<?php echo $hg2['logo_ufe']; ?>",
