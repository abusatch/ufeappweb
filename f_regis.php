...
{        
         "success": 0,
  "message": "L'e-mail ne peut pas être vide <?php //echo $_POST['ket_level'] ?>"
...
<?php
    }else if($_POST['place_birth'] == ""){
?>
{
             "success": 0,
  "message": "Place birth cannot be empty"
}

<?php
    }else if($_POST['date_birth'] == ""){
?>
{
             "success": 0,
...
<?php
    }else if($_POST['month_birth'] == ""){
?>
{
             "success": 0,
  "message": "Month birth cannot be empty"
}
...
<?php
        ...
        $tanggallahir = $_POST['date_birth']."-".$_POST['month_birth'];
