...
$wo = mysqli_query($koneksi,"select * from user where username = '$_GET[email]'");
$wo2 = mysqli_fetch_assoc($wo);
$nj = mysqli_query($koneksi,"select * from user where idUser = '$wo2[idUser]'");
...
$sql_get_data = "SELECT * FROM tb_order_aktif where id_user = '$idmemberr' and tanggal_akhir >= '$tang22'  ORDER BY id_order_aktif DESC limit $stur,$limit";
...
// $gf2 = mysqli_fetch_array($gf);
  ...
  $nh = mysqli_query($koneksi,"select * from user where idUser = '$wo2[idUser]'");
