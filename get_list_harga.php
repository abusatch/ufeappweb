...
$je = mysqli_query($koneksi,"select * from tb_harga_program where id_activites = '$_GET[id]'");
$je2 = mysqli_fetch_assoc($je);

if($_GET['filter'] == ""){
$sql_get_data = "select * from tb_harga_program where id_activites = '$_GET[id]'";
...
"idUser":"<?php echo $row['id_harga']; ?>",
  "username":"IDR. <?php echo number_format($row['harga'],0,".",","); ?>",
  "first_name":"<?php echo $row['keterangan']; ?>",
