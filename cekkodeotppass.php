...
[{
    ...
    $wd = mysqli_query($koneksi,"select * from user where username = '$_POST[username2]'  and verifikasi  = 'sudah'");
    $wd2 = mysqli_fetch_assoc($wd);
if(mysqli_num_rows($wd) == 0){
    ?>
[{
    "success" :0,
    "message" :"L'e-mail n'a pas été confirmé par l'administrateur"
}]
    <?php
}else{
    ?>
