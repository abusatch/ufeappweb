...
$judul1 = str_replace("&kutipsatu&","'",$rt2['judul']);
$deskripsi1 = str_replace("&kutipsatu&","'",$rt2['deskripsi']);
...
?>
              ...
              <h4 class="modal-title">16. Edit <?php echo $rt2['judul'] ?></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
...
$rg2 = mysqli_fetch_array($rg);
		...
		<td>
        <?php 
        $tulisan11 = str_replace("&kutipsatu&","'",$rg2['tulisan1']);
        ?>
...
mysqli_query($koneksi,"insert into tb_agent (
id_kategori,
judul,
judul2,
short_desc,
...
?>
			...
			<center>
			<i><font style="font-size:10px;">* mode kamera landscape
			</font></i><br><img src="" id="product_imageee2" style="width:1px;height:1px;" name="product_imageee2" class="img-thumbnail">
			</center>
							  <script>
 ...
 <div class="input-group mb-3" style="margin-top:10px;">
          ...
          <input type="hidden" name="idc2" value="<?php echo $_GET['id'] ?>" />
             ...
             <div style="margin-top:15px;">
                ...
                <!-- <textarea class="textarea" name="deskripsi" placeholder="Place some text here" -->
                <textarea class="form-control" name="long_desc" placeholder="Place some text here"><?php echo $kj2['long_desc'] ?></textarea>
        ...
        reader.readAsDataURL(input.files[0]);
          ...
          <input type="hidden" name="idc2" value="<?php echo $_GET['id'] ?>" />
                ...
                <textarea class="form-control" name="short_desc" placeholder="Place some text here"
                           ...
                           ><?php echo $kj2['short_desc'] ?></textarea>
