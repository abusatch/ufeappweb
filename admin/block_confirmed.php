...
?>
              ...
              <li class="breadcrumb-item active">Block Confirmed</li>
                            </ol>
            </div>
                   ...
                   <?php 
                   include('../db.php');
                   $kj = mysqli_query($koneksi,"select * from tb_banding where status is not null or status != '' order by tanggal desc");
    ...
    <div class="table-responsive" style="padding:5px;">
      ...
      $tanggal_akhir = date('H:i Y-m-d', strtotime($tanggal_awal . ' +1 year'));
            ?>
                                              ...
                                              <tr>
                            <td><?php echo $no; ?></td>
                            <td><?php echo substr($kj2['tanggal2'],0,16); ?></td>
...
<input type="hidden" value="<?php echo $kj2['id_banding']; ?>" name="id_banding"/>
        ...
        <div>
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="submit" style="display:none;" name="updatekategori" class="btn btn-primary">Accept</button>
            </div>
      </form>
          </div>
          <!-- /.modal-content -->
