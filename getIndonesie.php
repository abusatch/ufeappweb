...
if($_GET['jenis'] == "france"){
    $sql_get_fasilitas = "select * from tb_menu where jenis = 'france'";
...
<?php if($no == 1){}else{echo ",";} ?>
  ...
  {    
       ...
       "title": "<?php echo $de2['nama_menu'] ?>",
        ...
        "image": "https://ufe-section-indonesie.org/ufeapp/images/menu/<?php echo $de2['gambar2'] ?>",

        "rating": "<?php echo $desk7; ?>",

        "releaseYear": "<?php echo $desk7; ?>",

        "genre": "<?php echo  $de2['id_menu']; ?>"
