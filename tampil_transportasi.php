...
$sql_get_transportasi = "SELECT * FROM tb_transportasi ORDER BY id ASC";
$conn->set_charset("utf8");
$query = $conn->query($sql_get_transportasi);
...
$response = ['status' => $status, 'transportasi' => $response_data];
