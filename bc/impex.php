...
//KONEKSI.. 
$host='localhost';
$username='u978693660_bk';
$password='s4trian148';
$database='u978693660_toko';
...
//Script Upload File..
    ...
    while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) {
        $import="INSERT into barang (idBarang,nmBarang,harga) values (NULL,'$data[0]','$data[1]')"; //data array sesuaikan dengan jumlah kolom pada CSV anda mulai dari “0” bukan “1”
