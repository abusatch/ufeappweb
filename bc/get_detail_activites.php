...
<?php
$fr = mysqli_query($koneksi,"select * from tb_activites where id_activites = '$_POST[id_activites]'");
...

{
  ...
  "nama_depan": "<?php echo $row['first_name'] ?>",
   "nama_instruktur": "<?php echo $fr2['instruktur'] ?>",
    "ket_instruktur": "<?php echo $fr2['ket_instruktur'] ?>",
