...
$fs = mysqli_query($koneksi,"select * from tb_order where id_user = '$hk3[idUser]' order by id_order desc");
...
"ket_levell":"<?php echo $kj2['level'] ?>",    
 ...
 "harga_order":"IDR. <?php echo number_format($fs2['harga'],0,',','.') ?>",
  "ket_biaya":"<?php echo $fs2['nama_produk'] ?>",
    "id_orderr":"<?php echo $fs2['id_order'] ?>",
"harga_asli":"<?php echo $fs2['harga'] ?>",
 "nama_bank":"<?php echo $dr2['nama_bank'] ?>",
 "no_rek":"<?php echo $dr2['no_rek'] ?>",  
 "atas_nama":"<?php echo $dr2['atas_nama'] ?>",    
 
 "email_user":"<?php echo $hk3['username'] ?>",    
 "id_user":"<?php echo $hk3['idUser'] ?>",    
 "level_user":"<?php echo $hk3['level'] ?>",    
