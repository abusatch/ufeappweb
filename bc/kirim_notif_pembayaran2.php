...
// How to use
$titleNoti = "Le paiement est confirmé";
$bodyNoti = "Paiement confirmé par Admin";
//$bodyNoti = "Pembayaran di konfirmasi oleh Admin".$_GET['email'];
...
$te = mysqli_query($koneksi,"select * from tb_order where id_order = '$_GET[id_order]'");
$te2 = mysqli_fetch_array($te);

		$ewww = mysqli_query($koneksi,"select * from user where idUser = '$te2[id_user]'");
while ($tyu = mysqli_fetch_array($ewww)){
...
// How to use
$titleNoti = $te2['username'];
$bodyNoti = "Terima kasih pembayaran Anda telah dikonfirmasi";
$actionNoti = "https://medium.com/@ptuckyeagle";
$gambarrr = "https://ufe-section-indonesie.org/ufeapp/berhasil.png";
