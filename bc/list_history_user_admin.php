...
$sql_get_data = "SELECT * FROM tb_order where  ket = 'sudahdibayar' ORDER BY tanggal DESC limit $start,$limit";
...
// $gf2 = mysqli_fetch_array($gf);
  ...
  $ml = mysqli_query($koneksi,"select * from tb_order_aktif where id_order = '$row[id_order]'");
  $ml2 = mysqli_num_rows($ml);
