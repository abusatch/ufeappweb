...
<?php
   ...
   $tahun_member = date('Y',strtotime($date1 . "+0 days"));
   $tahun_sekarang = date('Y');
   
   $masa_ak = date('D M d, Y ',strtotime($date1 . "+0 days"));
   $masa_ak2 = date('d',strtotime($date1 . "+0 days"));
   $masa_ak3 = date('m',strtotime($date1 . "+0 days"));
   ...
   $mass = $masa_ak2 - $t1;
   if($tahun_member == $tahun_sekarang){
   
   if($t2 == $masa_ak3){
   
   $masa_ak3 =  " (".$mass." hari dari sekarang)";
   }else{
   $masa_ak3 =  "";
   ...
   $masa_ak3 =  "1 tahun lagi";
    
   }
	
	
 	if ($GET['filter'] != "dfffsdfdsfdsfs"){
...
?>
{
  ...
  "phone": "<?php echo $row['phone'] ?>",
    "masa_aktif": "<?php echo $masa_ak ?><?php echo $masa_ak3 ?>",
