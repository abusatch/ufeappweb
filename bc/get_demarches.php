...
$sql_get_actualite = "select * from tb_demarches order by id_demar asc";
...
?>

  {
    ...
    "url":"<?php echo $de2['id_demarches'] ?>",
    "bio":"<?php echo  substr($de2['short_desc'],0,150)  ?>",
     
      "regular": "https://ufe-section-indonesie.org/ufeapp/images/demarches/<?php echo $de2['gambar'] ?>"
