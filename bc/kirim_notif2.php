...
<body>
<p>Hello Admin, ada user yang menambahkan artikel. cek yu</p>
<table>
...
class startSendNotification
{
		...
		$ewww = mysqli_query($koneksi,"select * from user where level = 'admin-ufe' ");
...
// How to use
$titleNoti = "Hello Admin, Cekidot";
$bodyNoti = "User menambahkan artikel ".$_GET['deskripsi'];
$actionNoti = "https://medium.com/@ptuckyeagle";
$gambarrr = "https://ufe-section-indonesie.org/ufeapp/images/actualite/".$_GET['gambar'];
