...
$vd = mysqli_query($koneksi,"select * from user where username = '$_GET[em]'");
$vd2 = mysqli_fetch_array($vd);
...
if($vd2['level'] == "vip-admin"){
$message = $message."<p>Code VIP</p>
<table>

<tr>
<td style='font-size:20px;font-weight:500;'><b>".$vd2['kode_vip']."</b></td>
</tr>
</table>";
}
