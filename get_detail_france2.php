...
if($_GET['filter'] == ""){
$sql_get_data = "select * from tb_tulisan where jenis = 'splash_indo' limit 1";
...
$wjd = mysqli_query($koneksi,"select * from tb_tulisan where jenis = 'info_france'");
$wjd2 = mysqli_fetch_assoc($wjd);
...
$des7 = str_replace(".","",$des6);


?>
"idUser":"<?php echo $hg2['id_profile']; ?>",
  "username":"<?php echo $deskk7; ?>",
  "first_name":"<?php echo $row['nama_menu'] ?>",
  "second_name":"<?php echo $deskk7; ?>",
  "judul":"<?php echo $de7; ?>",
  "short_desc":"<?php echo $des7; ?>",
  ...
  "cover":"https://ufe-section-indonesie.org/ufeapp/images/<?php echo $wjd2['tulisan4'] ?>",
  "logo":"https://ufe-section-indonesie.org/ufeapp/images/<?php echo $wjd2['tulisan5']; ?>",
