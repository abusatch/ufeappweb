<?php 
	...
	$response = array();
        ...
        $sql = mysqli_query($koneksi,"SELECT * FROM user WHERE username='$_POST[username2]' and password = '$_POST[pss2]'");    
        }
        ...
        if($_POST['level'] == "ganti_password"){
            ...
            mysqli_query($koneksi,"UPDATE user set password = '$psd' where idUser = '$_POST[username]' and password = '$password'");
                ...
                mysqli_query($koneksi,"UPDATE user set password = '$psd' where username = '$_POST[username2]' and password = '$_POST[pss2]'");
            ...
            $response['new_pss'] = md5($_POST['deskripsi']);
        ...
        employement = '$_POST[employement]',
        company = '$company1'
         where username = '$_POST[username2]' and password = '$_POST[pss2]'");   
        }
