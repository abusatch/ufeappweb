...
$sql_get_data = "SELECT * FROM tb_order where id_user = '$idmemberr' and (ket = 'belumdibayar' or ket = 'menunggu') and hapus = '2' and no_invoice like '%$_GET[cari]%'  ORDER BY id_order DESC limit $stur,$limit";
...

{
      ...
      <?php if($row['jenis_order'] == "creche"){ ?>
      "gambar": "https://ufe-section-indonesie.org/ufeapp/images/activites/mn_creche.jpg",
      
      <?php }else if($row['jenis_order'] == "memberufe"){ ?>
            "gambar": "https://ufe-section-indonesie.org/ufeapp/images/mn_ufe.jpg",
      <?php }else{ 
?>
