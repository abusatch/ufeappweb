...
$sql_get_data = "select * from tb_halaman_depan ";
    ...
    $nf = mysqli_query($koneksi,"select * from tb_demar2 where id_demar = '$_GET[id_demar]'");
    $nf2 = mysqli_fetch_assoc($nf);

    $sql_get_data = "SELECT * FROM tb_demar2 where id_demar = '$_GET[id_demar]'";
  }
...
"idUser":"<?php echo $hg2['id_profile']; ?>",
  "username":"Sur \nL`Indonésie",
  "first_name":"<?php echo $row['judul'] ?>",
  "second_name":"Sur \nL`Indonésie",
  "deskripsi":"<?php echo $deskk7; ?>",
  "phone":"<?php echo $hg2['telepon']; ?>",
  "mobile":"<?php echo $hg2['mobile']; ?>",
  "propic":"https://ufe-section-indonesie.org/ufeapp/images/menu/<?php echo $row['gambar']; ?>",
