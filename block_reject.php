...
echo "Access denied";    
    ...
    $bfw = mysqli_query($koneksi,"select * from tb_banding_reject where username = '$_POST[email]' and tanggal2 = '$tanggal2'");
    
    if(mysqli_num_rows($bfw) == 0){
        $kq = mysqli_query($koneksi,"insert into tb_banding_reject (username,alasan, tanggal,tanggal2, telp, id_banding)
        values
        ('$_POST[email]',
        '$_POST[text]',
        '$tanggal',
...
<p style='font-size:15px;text-align:justify;'><b>Bonjour ".$namanya.",</b> <br><br><br>Setelah kami melakukan review, sangat di sayangkan untuk saat ini akun Anda belum dapat di aktifkan dengan alasan:<br><br>
<b>".$_POST['text']."</b>
</p>
<br>
