<?php
  ...
  $hariini = date('Y-m-d');
   ...
   // $stop_date = '2009-09-30 20:24:00';
    ...
    $lkm = mysqli_query($koneksi,"SELECT * FROM user where username = '$_POST[username2]' and password = '$_POST[pss2]'  "); 
    }
...

{
  ...
  "masa_aktif": "<?php echo $row['masa_aktif'] ?>",
   ...
   $deskripsi2 = str_replace("\n"," ",$deskripsi1);
   $deskripsi3 = str_replace("<br>","-enter-",$deskripsi2);
