...
$sql_get_data = "select * from tb_template where visibility = '1' and id_member_vip = '$hrw2[id_member_vip]' and keterangan = 'release' order by tanggal desc limit 1";
...
//echo "ini".$pd2['id_member_vip'];
    ...
    $pd = mysqli_query($koneksi,"select * from tb_template where visibility = '1' and id_member_vip = '$hrw2[id_member_vip]' order by tanggal desc limit 1");
    $pd2 = mysqli_fetch_assoc($pd); 

$sql_get_data = "select * from tb_template where visibility = '1' and id_member_vip = '$hrw2[id_member_vip]' order by tanggal desc limit 1";
