...
if($_GET['from'] != "member"){
    ...
    $sql_get_activities_artistiques = "select * from tb_actualite order by id_actualite desc limit 1";

}else{
    
    $sql_get_activities_artistiques = "select * from tb_template where keterangan = 'release' order by id_template desc limit 1";
...
?>
...

  {
    ...
    "popup":  {
        ...
        "judul": "<?php echo $de2['judul'] ?>",
      "location": "tes",
      "url": "<?php echo $de2['url'] ?>",
      "gambar": "https://ufe-section-indonesie.org/ufeapp/images/actualite/<?php echo $de2['gambar'] ?>",
      "short_desc": "<?php echo $desk7 ?>",
      "id_actualite": "<?php echo $de2['id_actualite'] ?>",
